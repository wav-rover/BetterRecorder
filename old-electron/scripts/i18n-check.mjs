/**
 * Ensures all locale dirs under src/i18n/locales match the English key structure.
 * This project ships English-only; extra locales are optional parity checks.
 */
